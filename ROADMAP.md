...
The same fusion work that delivered 159–720× over PyTorch on the fusion benchmark fleet applies directly here. We already recreated the TVM shader set (see `../fused-lora/src/tvm-shaders/`) — the pattern transfers.
